...
from fishbone_diagram_generator.xml_loader import XMLLoader
from fishbone_diagram_generator.diagram_painter import DiagramPainter
...
from fishbone_diagram_generator.pptx_saver import PPTXSaver
from fishbone_diagram_generator.svg_saver import SVGSaver
from fishbone_diagram_generator.png_saver import PNGSaver
...
class MainApp(App):
    ...
    def build(self):
        if os.path.exists('fishbone_diagram_generator/fonts/ipaexg.ttf'):
            resource_add_path('fishbone_diagram_generator/fonts/')
